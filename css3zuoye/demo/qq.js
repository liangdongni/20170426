...
//     }
// };
// if (/QQBrowser/.test(navigator.userAgent) && /Chrome\/31/.test(navigator.userAgent)) {
//     window.location.href = "./index_parallax.html" + location.search;
// }
...
function core(pn, loop) {
    ...
    if (pn == 0) {
        ...
        bg.velocity({ rotateZ: '90deg', translateX: '-7000px', scale: 3 }, { duration: 0 }).velocity({ opacity: 1, scale: 0.6, translateX: '0px', translateY: '0px', rotateZ: '0deg' }, { duration: pub_t * 3, easing: 'ease' });
    } else if (pn == 1) {
    ...
    if (pn == 0) {
        ...
        $('#subtitle').velocity({ opacity: 0, translateZ: 0, rotateY: 0, rotateX: 0 }, { duration: 0 });
        ...
        slogan2.velocity({ rotateY: '-15deg', rotateX: '-30deg', translateZ: '3100px', translateX: '0px', translateY: '0px', scale: .1, opacity: 1 }, { duration: 0 });
        slogan3.velocity({ rotateY: '0deg', rotateX: '-30deg', translateZ: '3000px', translateX: '0px', translateY: '0px', scale: .1, opacity: 1 }, { duration: 0 });
        // p0 i
        p081.velocity({ rotateY: 0, translateZ: '0px', rotateX: 0 }, { duration: pub_t * 1 });
        ...
        slogan1.velocity({ rotateZ: '0deg', rotateY: '0deg', rotateX: '0deg', translateZ: '0px', translateX: '0px', translateY: '0px', scale: 1 }, { duration: pub_t * 2.3, easing: 'ease' });
        slogan2.velocity({ rotateY: '0deg', rotateX: '0deg', translateZ: '0px', translateX: '0px', translateY: '0px', scale: 1 }, { duration: pub_t * 2.3, easing: 'ease', delay: pub_t * 0.1 });
        slogan3.velocity({ rotateY: '0deg', rotateX: '0deg', translateZ: '0px', translateX: '0px', translateY: '0px', scale: 1 }, { duration: pub_t * 2.3, easing: 'ease', delay: pub_t * 0.2 });

        p0btn.css('display', 'block');
        p0btn.velocity({ opacity: 1 }, { duration: pub_t, delay: 2000 });
        ...
        $('#p3ui').velocity({ translateZ: '1200px', rotateX: '120deg' }, { duration: 1500 })
        $('#title3').velocity({ rotateX: '20deg', translateZ: '2000px' }, { duration: 2000 })
        $('#title3_1').velocity({ opacity: 0 }, { duration: 2000 })
        ...
        var p0away = function() {
                ...
                $('#subtitle').velocity({ opacity: 0, translateZ: 0, rotateY: 0, rotateX: 0 }, { duration: pub_t / 2 });
                // p0t2.velocity('fadeOut',{duration:pub_t});
            }
            // p0away();
            // p1 in
        var p1in = function() {
            $('#stage2').velocity({ rotateX: '0deg', rotateY: '0deg', translateZ: '-6000px', scale: 0.1, opacity: 0 }, { duration: 0 }).velocity({ rotateX: '0deg', rotateY: '0deg', translateZ: '0px', scale: 1, opacity: 1 }, { duration: 1000, easing: 'ease-out', delay: 1200 })
            $('#title1_2').velocity({ rotateX: '-10deg', translateZ: '-2000px' }, { duration: 0 }).velocity({ rotateX: 0, translateZ: '0px' }, { duration: 1000, easing: 'ease', delay: 1200 });
            $('#stage0').velocity({ opacity: 1, translateZ: 0 }, { duration: 0 }).velocity({ translateZ: '2000px' }, { duration: 2200, easing: 'ease', delay: 1000 })
            $('#layer4 img').velocity({ rotateZ: '-120deg' }, { duration: 0 }).velocity({ rotateZ: '0deg' }, { duration: 1200, delay: 600 })
            $('#page1').velocity({ rotateX: '120deg', rotateY: '-180deg', translateZ: '1000px', scale: 0.1, opacity: 0 }, { duration: 0 }).velocity({ rotateX: '0deg', rotateY: '0deg', translateZ: '0px', scale: 1, opacity: 1 }, { duration: 2200, easing: 'ease', delay: 0 });
        ...
        $('#p3ui').velocity({ rotateY: 0, translateX: 0, translateZ: '-50px', rotateX: '30deg', opacity: 1 }, { duration: 2000, easeing: 'ease' })
        $('#title3').velocity({ rotateY: 0, translateZ: 0, rotateX: 0 }, { duration: 2000, easeing: 'ease' })
        $('#title3_1').velocity({ opacity: .7 }, { duration: 600, easeing: 'ease', delay: 1800 })
            // p1 away
        var p1away = function() {
            $('#stage2').velocity({ translateZ: '2000px' }, { duration: 2000, easing: 'ease' })
            $('#title1_2').velocity({ translateZ: '1000px' }, { duration: 2000, easing: 'ease' });
        }
        p1away();
        // p2 in
        var p3standby = function() {
        ...
        $('#title3').velocity({ rotateY: '-60deg', translateZ: '2000px' }, { duration: 2000 })
        $('#title3_1').velocity({ opacity: 0 }, { duration: 500 })
