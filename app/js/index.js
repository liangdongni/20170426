        ...
        success: function(data) {
            ...
            $.each(obj, function(index, value) {
                if (obj[index].img == undefined) {
                    html += '<div class="col-md-12 joke"><h2>' + obj[index].title + '</h2><p>' + obj[index].year + '.' + obj[index].month + '.' + obj[index].day + '</p></div>'
                } else {
                    html += '<div class="col-md-12 joke"><h2>' + obj[index].title + '<span>' + obj[index].year + '.' + obj[index].month + '.' + obj[index].day + '</span></h2><p><img class="img-responsive" src="' + obj[index].img + '"/></p></div>'
                }
            })
            $(".history").append(html);
            text();
